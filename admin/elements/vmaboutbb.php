 ...
 */
class JFormFieldVmAboutbb extends JFormField {
    ...
    protected function getInput() {
        ...
        $html = '<div style="float:left">
                <img src="'.JURI::root().$path.DS.'logo_bancodobrasil.jpg" border="0"/><br />
                <h1> Plugin de pagamento Banco do Brasil para Virtuemart 3.0.</h1>
